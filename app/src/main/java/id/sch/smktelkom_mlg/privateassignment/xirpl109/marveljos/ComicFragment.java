...
import id.sch.smktelkom_mlg.privateassignment.xirpl109.marveljos.adapter.ComicAdapter;
...
import id.sch.smktelkom_mlg.privateassignment.xirpl109.marveljos.model.ResponseComic;
 ...
 */
public class ComicFragment extends Fragment implements ComicAdapter.IcomAdapter {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new ComicAdapter(comics, getContext(), this);
    }
            ...
            try {
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected void onPostExecute(Void aVoid) {
                        ...
                        favsave = new Favorite(comic.id, comic.title, comic.description, gambar, price.price);
