...
public class ComsDetActivity extends AppCompatActivity implements CharacterAdapter.charListener {
    public CharacterAdapter adapter;
    public List<Character> aChar = new ArrayList<>();
    public int ID = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this)
                ...
                .into(ivCom);
        ID = comic.id;
        adapter = new CharacterAdapter(aChar, this, null);
